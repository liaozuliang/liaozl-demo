...
public class KafkaUtils {
    ...
    public static void main(String[] args) {
        boolean ret = addPartitions(ZOOKEEPER_CONNECT, KafkaTopics.MULTI_PARTITIONS_TOPIC, 5);
        System.out.println("addPartitions result:" + ret);
    }
    ...
    public static boolean addPartitions(String zookeeperUri, String topic, int partitionNum) {
        ...
        try {
            AdminUtils.addPartitions(zkUtils, topic, assignment.get(topic).get(), allBrokerMeta, partitionNum, Option.empty(), false);
